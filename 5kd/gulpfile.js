...
var electronVersion = '0.30.4',
    packageName = 'BendAngleViewer',
    fullName = 'BendAngleViewer'
...
gulp.task('electron-package', ['package-clean', 'build'], function(cb) {
  ...
  if (platform === 'darwin') {
    ...
    opts.icon = 'app/assets/icon.ico';
    opts['version-string'] = {
      CompanyName: 'DMI INTERNATIONAL',
      LegalCopyright: '2015',
      FileDescription: 'True Degrees',
...
gulp.task('copy-license-readme', ['electron-package'], function() {
  ...
  return gulp.src(['LICENSE', 'readme.pdf'])
