      ...
      <DeviceView header='Information' index={this.props.params.index}>
        ...
        <form>
          <div className='form-group'>
            ...
            <textarea id='rx' className="form-control" rows="5" readOnly style={{'backgroundColor': '#ffffff'}}></textarea>
          </div>
          <div className='form-group'>
            <label htmlFor='tx'>Send:</label>
            <input id='tx' className='form-control'/>
          </div>
          <button type='button' className='btn btn-default' onClick={this.print}>PRINT</button>
